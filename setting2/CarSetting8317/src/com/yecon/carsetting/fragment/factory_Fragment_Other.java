...
public class factory_Fragment_Other extends DialogFragment implements onOneButtonListener,
	...
	int ID_OneButton[] = { R.id.factory_car_type, R.id.factory_mic_volume, R.id.factory_avin_channel, R.id.factory_tv_type,
	...
	int ID_OneCheck[] = { R.id.factory_headlight_detection, R.id.factory_brake_enable,
			...
			R.id.factory_voice_touch, R.id.factory_voice_wakeup_touch, R.id.factory_qicaideng_touch};
...
//				.setPromptTitle(stringarray_front_camera[XmlParse.videoport_front_camera]);
		...
		((HeaderLayout) rootView.findViewById(R.id.factory_qicaideng_touch)).getOneCheckBox()
		.setChecked(XmlParse.qicaideng_enable == 1 ? true : false);
	...
	public void onOneButtonClick(View view) {
		...
		case R.id.factory_avin_channel:
			Function.onSet_factory_avin_channel(mFragmentManager);
			break;
...
//			break;
	...
	public void onCheckout(View view, boolean value) {
		...
		case R.id.factory_voice_wakeup_touch:
			...
			break;
		case R.id.factory_qicaideng_touch:
			XmlParse.qicaideng_enable = value == true ? 1 : 0;
			break;
		default:
			break;
		}
